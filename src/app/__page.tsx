    ...
    <div className={`root ${loaded ? "on" : ""}`}>
      ...
      <div className="grid">
        ...
        {tab === "links" && (<>
          <div className="kpi-row">
            {[
              { label: "Human Clicks", value: linkData.humanClicks, delay: 0 },
              { label: "Top Destination", value: "60th Street", delay: 80 },
              { label: "Primary Source", value: "Link in Bio", delay: 160 },
            ].map((k, i) => (
          ...
          <div style={{ background: "rgba(143,161,166,0.12)", border: "1px solid rgba(143,161,166,0.35)", borderRadius: 14, padding: "18px 22px" }}>
            ...
            <div style={{ fontSize: 13, lineHeight: 1.7, color: "#5C4E54" }}>60th Street is the clear top destination with 50 clicks (34% of all attributed traffic), followed by 5th Ave (26) and 58th Street (25). Link in Bio drives 43% of sourced traffic, with referral close behind at 40%. NYC accounts for 48 of 133 U.S. clicks, confirming strong local audience alignment. Bot traffic was detected and excluded from all reporting to ensure accuracy.</div>
          </div>
        </>)}
